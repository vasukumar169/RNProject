...
import {dayPSingleStoreData} from "./../utilities/GenericMessages"
...
export default class DayPartStoreBoard extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      carCount:{},
  ...
  componentDidMount () {
    if(!isEmpty(this.props.singleStore.dayPart) )
  ...
  refineData = () =>{
    carCount = Object.assign({},this.props.singleStore.dayPart.CarCount)
    totalTime = Object.assign({},this.props.singleStore.dayPart.Total)
    detectorData = Object.assign({},this.props.singleStore.dayPart)
    // carCount = Object.assign({},dayPSingleStoreData.dayPart.CarCount)
    // totalTime = Object.assign({},dayPSingleStoreData.dayPart.Total)
    // detectorData = Object.assign({},dayPSingleStoreData.dayPart)
    ...
    // console.log(this.props.singleStore)
          ...
          <View style={[CommonStyles.flex7By2,CommonStyles.justifyCenterContent]}>
                {
                  ...
                  ?
                  <Icon name="gear"
                        onPress={()=>Actions.configAlert({tabType:"daypart",
      ...
      <View style={[CommonStyles.flexOne,CommonStyles.bgWhite]}>
        ...
        <View style={[CommonStyles.flexNine]}>
          <ScrollView refreshControl = {<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh.bind(this)} />}>
            {
            isEmpty(this.props.singleStore.dayPart) ?
