...
import {daySingleStoreData} from "./../utilities/GenericMessages"
...
export default class DayStoreBoard extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      carCount:{},
  ...
  componentDidMount () {
    if(!isEmpty(this.props.singleStore.day) )
  ...
  refineData = () =>{
    carCount = Object.assign({},this.props.singleStore.day.CarCount)
    totalTime = Object.assign({},this.props.singleStore.day.Total)
    detectorData = Object.assign({},this.props.singleStore.day)
    // carCount = Object.assign({},daySingleStoreData.day.CarCount)
    // totalTime = Object.assign({},daySingleStoreData.day.Total)
    // detectorData = Object.assign({},daySingleStoreData.day)
          ...
          <View style={[CommonStyles.flex7By2,CommonStyles.justifyCenterContent]}>
                {
                  ...
                  ?
                  <Icon name="gear"
                        onPress={()=>Actions.configAlert({tabType:"day",
      ...
      <View style={[CommonStyles.flexOne,CommonStyles.bgWhite]}>
        ...
        <View style={[CommonStyles.flexNine]}>
          <ScrollView refreshControl = {<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh.bind(this)} />}>
            {
            isEmpty(this.props.singleStore.day) ?
