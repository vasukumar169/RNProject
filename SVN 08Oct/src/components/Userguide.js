...
import {USER_GUIDE_URL_EN} from "./../utilities/HelperLabels"
import {USER_GUIDE_URL_FR} from "./../utilities/HelperLabels"
      ...
      <View style={Platform.OS=="ios" ? [CommonStyles.backGroundContainer,IosStyles.mTP35] : [CommonStyles.backGroundContainer]} >
        ...
        <View style={[CommonStyles.flex11]}>
          <WebView
            ...
            source={this.props.language=="fr-FR" ? {uri: USER_GUIDE_URL_FR}:{uri: USER_GUIDE_URL_EN}} />
        </View>
      </View>
    )
  }
