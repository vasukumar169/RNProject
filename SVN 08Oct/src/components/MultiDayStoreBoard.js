...
export default class MultiDayStoreBoard extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      carCount:{},
  ...
  getMultiStoreDataForDay = () => {
    getMultiStoreData(this.props.storeUIDS, this.state.uName, 'DAY', this.state.JWT)
      .then((response) => {
  ...
  refineData = () =>{
      detectorData = Object.assign({},this.state.singleStore.day)
  ...
  renderDetectData =() =>{
    ...
    for(let x in this.state.detectorData) {
      ++i
      a.push(
        <View key={i} style={[CommonStyles.rowFlexDir,CommonStyles.borderBottom1,
      ...
      <View style={[CommonStyles.flexOne,CommonStyles.bgWhite]}>
        ...
        <View style={[CommonStyles.flexNine]}>
          <ScrollView refreshControl = {<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh.bind(this)} />}>
            {
            isEmpty(this.state.singleStore.day) || isEmpty(this.state.singleStore)
            ?
            ...
            <View style={[CommonStyles.bgWhite,CommonStyles.flexOne]}>
              {/*Car Section Removed*/}
              {
                (this.state.singleStore.day).hasOwnProperty("Total")
                ?
              ...
              <View style={[CommonStyles.justifyCenterContent,CommonStyles.mTP22,CommonStyles.mB22]}>
                <View style={[CommonStyles.alignCenter,CommonStyles.rowFlexDir]}>
                  ...
                  <View style={[CommonStyles.flexTwo,CommonStyles.blueHeaderColor,CommonStyles.pTB11]}>
                    {
                      (this.state.singleStore.day).hasOwnProperty("CarCount")
                      ?
