...
export default class MultiDayPartStoreBoard extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      carCount:{},
  ...
  getMultiStoreDataForDP = () => {
    getMultiStoreData(this.props.storeUIDS, this.state.uName, 'DAYPART', this.state.JWT)
      .then((response) => {
  ...
  refineData = () =>{
      detectorData = Object.assign({},this.state.singleStore.dayPart)
      ...
      <View style={[CommonStyles.flexOne,CommonStyles.bgWhite]}>
        ...
        <View style={[CommonStyles.flexNine]}>
          <ScrollView refreshControl = {<RefreshControl refreshing={this.state.refreshing} onRefresh={this._onRefresh.bind(this)} />}>
            {
            isEmpty(this.state.singleStore.dayPart) || isEmpty(this.state.singleStore)
            ?
            ...
            <View style={[CommonStyles.bgWhite,CommonStyles.flexOne]}>
              {/*Car Section Removed*/}
              {
                (this.state.singleStore.dayPart).hasOwnProperty("Total")
                ?
              ...
              <View style={[CommonStyles.justifyCenterContent,CommonStyles.mTP22,CommonStyles.mB22]}>
                <View style={[CommonStyles.alignCenter,CommonStyles.rowFlexDir]}>
                  ...
                  <View style={[CommonStyles.flexTwo,CommonStyles.blueHeaderColor,CommonStyles.pTB11]}>
                    {
                      (this.state.singleStore.dayPart).hasOwnProperty("CarCount")
                      ?
