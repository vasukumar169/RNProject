...
<attr format="boolean" name="circleCrop"/>
  ...
  </style><style name="Theme"/></file><file name="preferences" path="D:\new\SVN 1 oct\trunk\node_modules\react-native-device-info\android\build\intermediates\exploded-aar\com.facebook.react\react-native\0.55.4\res\xml\preferences.xml" qualifiers="" type="xml"/></source></dataSet><dataSet config="main" generated-set="main$Generated"><source path="D:\new\SVN 1 oct\trunk\node_modules\react-native-device-info\android\src\main\res"/><source path="D:\new\SVN 1 oct\trunk\node_modules\react-native-device-info\android\build\generated\res\rs\debug"/><source path="D:\new\SVN 1 oct\trunk\node_modules\react-native-device-info\android\build\generated\res\resValues\debug"/></dataSet><dataSet config="debug" generated-set="debug$Generated"><source path="D:\new\SVN 1 oct\trunk\node_modules\react-native-device-info\android\src\debug\res"/></dataSet><mergedItems><configuration qualifiers=""><declare-styleable name="AlertDialog"><attr name="android:layout"/><attr format="reference" name="buttonPanelSideLayout"/><attr format="reference" name="listLayout"/><attr format="reference" name="multiChoiceItemLayout"/><attr format="reference" name="singleChoiceItemLayout"/><attr format="reference" name="listItemLayout"/></declare-styleable><declare-styleable name="SimpleDraweeView"><attr format="string" name="actualImageUri"/><attr format="reference" name="actualImageResource"/></declare-styleable><declare-styleable name="GenericDraweeHierarchy"><attr format="integer" name="fadeDuration"/><attr format="float" name="viewAspectRatio"/><attr format="reference" name="placeholderImage"/><attr name="placeholderImageScaleType">
      <enum name="none" value="-1"/>
      <enum name="fitXY" value="0"/>
      <enum name="fitStart" value="1"/>
      <enum name="fitCenter" value="2"/>
